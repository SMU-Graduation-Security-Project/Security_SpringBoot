...
public class WinnerController {
    ...
    public BaseResult createWinner(@RequestBody WinnerCreateReq winnerCreateReq) {
        try {
    ...
    public BaseResult getWinnerDetail(@PathVariable Long id) {
        try {
    ...
    public BaseResult updateWinner(@RequestBody WinnerUpdateReq winnerUpdateReq) {
        try {
    ...
    public BaseResult deleteWinner(@PathVariable Long id) {
        try {
