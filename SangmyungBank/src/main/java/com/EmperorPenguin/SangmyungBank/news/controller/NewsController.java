...
public class NewsController {
    ...
    public BaseResult createNews(
            @ApiParam(value = "새소식 객체", required = true)
            @RequestBody NewsCreateReq newsCreateReq
    ) {
        try {
    ...
    public BaseResult getNewsDetail(
            @ApiParam(value = "새소식 id",required = true)
    ...
    public BaseResult updateNews(
            @ApiParam(value = "변경된 새소식 객체", required = true)
            @RequestBody NewsUpdateReq newsUpdateReq
    ) {
        try {
